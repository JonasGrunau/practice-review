...
const formSchema = z.object({
  ...
  content: z
    ...
    .max(
      contentMaxLength,
      `Die Beschreibung darf höchstens ${contentMaxLength} Zeichen lang sein.`
    ),
});
  ...
  return (
    <Card className="w-full sm:max-w-md">
      <CardHeader>
        ...
        <CardDescription>
          Hilf uns dabei uns zu verbessern, indem du hier dein Feedback abgibst.
        </CardDescription>
      </CardHeader>
                  ...
                  <InputGroup>
                    ...
                    <InputGroupAddon align="block-end">
                      <InputGroupText className="tabular-nums">
                        {field.value.length}/{contentMaxLength} Zeichen
                      </InputGroupText>
                    </InputGroupAddon>
                  </InputGroup>
                  {fieldState.invalid && (
